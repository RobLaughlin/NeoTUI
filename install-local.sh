...
printf '  9) Enabling lf queue flow: yy/yY (toggle copy/cut), p/P (execute; copy queue persists), yq (status), c (clear)\n'
printf ' 10) Enabling lf undo/redo hotkeys: gu/gr (session-scoped)\n'
