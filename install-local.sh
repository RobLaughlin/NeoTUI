...
printf '  9) Enabling lf keybinds: gh (home), gz (toggle file preview), gs (sync to zsh dir), l/Enter (enter dir; files open in split/new window)\n'
printf ' 10) Enabling lf queue flow: yy/yY (toggle copy/cut), p/P (execute; copy queue persists), yq (status), c (clear)\n'
printf ' 11) Enabling lf undo/redo hotkeys: gu/gr (session-scoped)\n'
printf ' 12) Deleted files are recoverable only in current neotui session\n'
printf ' 13) Enabling zsh helper: lfsync (sync to lf directory)\n'
