...
main() {
    ...
    echo ""
    echo "  1. Install a Nerd Font in your terminal emulator"
    ...
    echo ""
    echo "  2. Start a zsh shell (or launch tui which uses zsh automatically):"
    echo "     zsh"
    echo ""
    echo "  3. Launch the TUI environment:"
    echo "     tui"
    echo ""
    echo "  4. First launch of Neovim will auto-install plugins & LSP servers."
